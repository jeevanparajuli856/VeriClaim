...
Create an ADR for decisions that materially affect architecture, security, data, deployment, or long-term maintainability.

Naming: `ADR-0001-short-title.md`.

## Current status

- `ADR-0001-human-authority-over-claim-outcomes.md` — accepted and reaffirmed for the one-day demo.
